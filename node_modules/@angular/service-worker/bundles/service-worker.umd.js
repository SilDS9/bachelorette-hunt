...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@angular/service-worker', ['@angular/core','exports', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,(global.ng = global.ng || {}, global.ng.serviceWorker = {}), global.ng.common, global.ng.core, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,exports, common, core, rxjs, operators) { 'use strict';
...
SwPush.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SwPush, factory: function (t) { return SwPush.ɵfac(t); } });
    ...
    function ngswAppInitializer(injector, script, options, platformId) {
        var initializer = function () {
            ...
            ngZone.runOutsideAngular(function () { return readyToRegister$.pipe(operators.take(1)).subscribe(function () { return navigator.serviceWorker.register(script, { scope: options.scope }).catch(function (err) {
                var errorHandler = injector.get(core.ErrorHandler);
