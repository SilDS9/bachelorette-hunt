(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@zxing/browser'), require('@zxing/library'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@zxing/ngx-scanner', ['@angular/core','@angular/common','@angular/forms','exports', '@angular/common', '@angular/core', '@angular/forms', '@zxing/browser', '@zxing/library', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.ng.forms,(global.zxing = global.zxing || {}, global.zxing['ngx-scanner'] = {}), global.ng.common, global.ng.core, global.ng.forms, global.browser, global.library, global.rxjs));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, common, core, forms, browser, library, rxjs) { 
var _c0 = ["preview"];
'use strict';
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ZXingScannerModule, { declarations: [ZXingScannerComponent], imports: [ɵngcc1.CommonModule, ɵngcc2.FormsModule], exports: [ZXingScannerComponent] }); })();
